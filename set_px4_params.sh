...
# Rangefinder config (currently configured for 8-drone frame)
param set SENS_TFMINI_CFG 104 # Serial 4
param set EKF2_RNG_AID 1
param set EKF2_RNG_POS_X 1.225 # X position of range finder origin in body frame (meters)
...
param set MPC_THR_MAX 1.2794873003072644 # ONLY used to calibrate stick input. Configured for for 8-drone frame.
                                         # See "maximum thrust value" output by simulation/generate_matrices_aviata.py.

# Controller Tuning - params generated by simulation/constants_4_drones.py
